...
# React Expandable Text Contributing Guide

Hello!, I am very excited that you are interested in contributing with React Expandable Text. However, before submitting your contribution, be sure to take a moment and read the following guidelines.

- [Code of Conduct](https://github.com/echoja/react-expandable-text/blob/canary/CODE_OF_CONDUCT.md)
...
- [Tsup](https://tsup.egoist.dev/) to bundle packages (예정)
